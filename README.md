...
[Simulation example](plot_examples/simulation_param_n_neighbors.png)
[Boxplot example](plot_examples/boxplot_param_n_neighbors.png)
...
Example of heatmap grid : [Heatmap example](plot_examples/heatmap_grid.png)

You will find further details about the project and references in the report (in french) : [Report](final_report.pdf)
